...
public class TrafficSimulation {
    ...
    private void simulationSamrary(){
        ...
        System.out.println(String.format(
            ...
            "ID", "Type", "Style", "Speed", "Direction", "TimeTaken", "IdealTime","TimeDifferance", "Passed","GetAccident"
        )
        );
    ...
    private void simulationSummary() {
        ...
        idealTimeColumn.setCellValueFactory(cellData -> {
            GeneralRules value = cellData.getValue();
            if (value instanceof Vehicle) 
                return new SimpleStringProperty(String.format("%-10.2f",((Vehicle) value).getIdealTime()));
            if (value instanceof Pedestrian) 
                return new SimpleStringProperty(String.format("%-10.2f",((Pedestrian) value).getIdealTime()));
            return new SimpleStringProperty("Unknown");
        });
