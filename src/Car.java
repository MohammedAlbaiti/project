...
public class Car extends Vehicle {
    ...
    private static final ArrayList<Image> carImages = new ArrayList<>(Arrays.asList(new Image("file:src/resources/car.png"),new Image("file:src/resources/car10.png"),new Image("file:src/resources/car2.png"),new Image("file:src/resources/car3.png"),new Image("file:src/resources/car4.png"),new Image("file:src/resources/car5.png"),new Image("file:src/resources/car6.png"),new Image("file:src/resources/car7.png"),new Image("file:src/resources/car8.png"),new Image("file:src/resources/car9.png"),new Image("file:src/resources/car11.png"),new Image("file:src/resources/car12.png"),new Image("file:src/resources/car13.png"),new Image("file:src/resources/car14.png")));
